...
API stands for Application Programming Interface and it is the software intermediary that delivers your request to the provider (can be a website) and then delivers the response back to you.
```python
# Example:
import os
import requests
